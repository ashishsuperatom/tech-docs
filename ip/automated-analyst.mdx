...
flowchart TB
    subgraph COMPLETE["THE COMPLETE DECISION ENGINE"]
        DATA["1. Data Connected<br>(Semantic Modeling)"]
        UNDERSTAND["2. Context Added<br>(Tribal Knowledge)"]
        ANALYZE["3. Analysis Performed<br>(Coding Agents)"]
        MONITOR["4. Continuous Monitoring<br>(Automated Analyst)"]
        INSIGHT["5. Insights Delivered<br>(Generative UI)"]
        ACTION["6. Actions Suggested<br>(Decision Loop)"]
    end

...
flowchart TB
    subgraph IP["SUPERATOM INTELLECTUAL PROPERTY"]
        direction TB
        I1["🔗 Multi-Source Semantic Understanding<br>Making sense of disconnected data"]
        I2["🎨 Generative UI<br>Auto-creating perfect visualizations"]
        I3["🧠 Tribal Knowledge System<br>Capturing organizational wisdom"]
        I4["🤖 Coding Agents for Enterprise<br>AI agents that understand business context"]
        I5["📊 Automated Semantic Modeling<br>Zero-setup data understanding"]
        I6["🔄 Automated Analyst<br>Continuous intelligence, even while you sleep"]
    end

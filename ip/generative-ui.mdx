...
```mermaid
flowchart TB
    Q["User Question<br>'Show me top products by revenue'"] --> UNDERSTAND["1. UNDERSTAND<br>Parse intent & entities"]

    UNDERSTAND --> QUERY["2. QUERY<br>Generate & execute SQL"]

    QUERY --> ANALYZE["3. ANALYZE<br>Profile result data"]

    ANALYZE --> SELECT["4. SELECT<br>Choose optimal component"]

    SELECT --> CONFIGURE["5. CONFIGURE<br>Set visualization parameters"]

    CONFIGURE --> RENDER["6. RENDER<br>Interactive UI component"]

...
const nodes: Node[] = [
  { id: 'data', type: 'custom', position: { x: 0, y: 100 }, data: { label: 'Data Model\nYour enterprise data', color: 'neutral', icon: '🗄️', tag: 'Source' } },
  ...
  { id: 'field', type: 'badge', position: { x: 720, y: 100 }, data: { label: 'Field Workers', color: 'success', icon: '👷' } },
];
...
const edges: Edge[] = [
  ...
  { id: 'e4', source: 'ios', target: 'field' },
  { id: 'e5', source: 'android', target: 'field' },
];

export default function MobileAppsDiagram() {

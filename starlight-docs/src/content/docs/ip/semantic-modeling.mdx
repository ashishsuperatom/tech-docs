...
flowchart TB
    ...
    subgraph ANALYSIS["ANALYSIS PIPELINE"]
        direction TB
        A1["Stage 1: Schema Analysis\nStructure & relationships"]
        A2["Stage 2: Sample Extraction\nRepresentative data"]
        A3["Stage 3: Statistical Profiling\nPatterns & distributions"]
        A4["Stage 4: Domain Classification\nBusiness context"]
        A5["Stage 5: Query Generation\nPossible questions"]
    end

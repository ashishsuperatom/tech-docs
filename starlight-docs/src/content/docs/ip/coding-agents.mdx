...
import CodingAgentFlowDiagram from '../../../components/diagrams/ip/CodingAgentFlowDiagram';
import AgentReasoningLoopDiagram from '../../../components/diagrams/ip/AgentReasoningLoopDiagram';
import ToolRegistryDiagram from '../../../components/diagrams/ip/ToolRegistryDiagram';
import ModelStrategyDiagram from '../../../components/diagrams/ip/ModelStrategyDiagram';
...
<CodingAgentFlowDiagram client:load />
...
<AgentReasoningLoopDiagram client:load />
...
<ToolRegistryDiagram client:load />
...
<ModelStrategyDiagram client:load />

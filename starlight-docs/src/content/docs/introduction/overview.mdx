...
import DecisionLoopDiagram from '../../../components/diagrams/DecisionLoopDiagram';
import ProblemsSolutionsDiagram from '../../../components/diagrams/ProblemsSolutionsDiagram';
...
<CardGrid>
  <LinkCard title="1. The Data Problem" href="/introduction/problems#1-the-data-problem" description="Data isn't clean, connected, or contextualized" />
  <LinkCard title="2. The Tacit Knowledge Problem" href="/introduction/problems#2-the-tacit-knowledge-problem" description="Critical knowledge lives in people's heads, not systems" />
  <LinkCard title="3. The Execution Problem" href="/introduction/problems#3-the-execution-problem" description="Insights need to be accessible, visual, and auditable" />
  <LinkCard title="4. The Action Problem" href="/introduction/problems#4-the-action-problem" description="AI suggestions don't account for organizational reality" />
  <LinkCard title="5. The Accessibility Problem" href="/introduction/problems#5-the-accessibility-problem" description="Data needs to be available everywhere, not just desktops" />
  <LinkCard title="6. The Delivery Problem" href="/introduction/problems#6-the-delivery-problem" description="Insights must come to users, not wait to be queried" />
  <LinkCard title="7. The Security Problem" href="/introduction/problems#7-the-security-problem" description="Enterprise data requires enterprise-grade protection" />
</CardGrid>
...
<ProblemsSolutionsDiagram client:load />
...
<CardGrid>
  <Card title="< 3 seconds" icon="rocket">
    Average query response time
  </Card>
  <Card title="90-99%" icon="seti:salesforce">
    Infrastructure cost reduction
  </Card>
  <Card title="~15 minutes" icon="approve-check">
    New project setup time
  </Card>
  <Card title="4 LLM Providers" icon="puzzle">
    No vendor lock-in
  </Card>
  <Card title="16+ Components" icon="bars">
    Automatic visualization selection
  </Card>
  <Card title="Zero Data Storage" icon="approve-check-circle">

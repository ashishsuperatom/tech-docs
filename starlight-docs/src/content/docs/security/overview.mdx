...
flowchart TB
    subgraph ENTERPRISE["YOUR ENTERPRISE NETWORK"]
        DATA["Your Data"]
        SA["Superatom Platform"]
        DATA <--> SA
    end

    subgraph GUARANTEES["SECURITY GUARANTEES"]
        G1["Zero Data Storage"]
        G2["Ephemeral Processing"]
        G3["End-to-End Encryption"]
        G4["Enterprise IAM"]
    end
    ...
    style ENTERPRISE fill:#d1fae5,stroke:#0D9373
...
flowchart TB
    subgraph LAYERS["SECURITY LAYERS"]
        ...
        L2["Layer 2: Project Isolation\n• Each project in separate Durable Object\n• Zero cross-project data access\n• Independent scaling"]

        L3["Layer 3: Data Protection\n• Parameterized SQL queries\n• Encrypted connections (TLS/SSL)\n• API key hashing"]

        L4["Layer 4: Message Validation\n• Zod schema validation\n• Type-safe communication\n• Input sanitization"]
    end

...
graph LR
    ...
    style WS fill:#2d3748,stroke:#4a5568,color:#e2e8f0
    style MA fill:#2d3748,stroke:#4a5568,color:#e2e8f0
    style LLM fill:#1a365d,stroke:#2b6cb0,color:#e2e8f0
...
The LLM is a stateless inference service. Each request is constructed from scratch — no state persists between calls.

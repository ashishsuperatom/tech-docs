...
graph TD
    ...
    style MA fill:#2d3748,stroke:#4a5568,color:#e2e8f0
    style RA1 fill:#1a365d,stroke:#2b6cb0,color:#e2e8f0
    style RA2 fill:#1a365d,stroke:#2b6cb0,color:#e2e8f0
    style RA3 fill:#1a365d,stroke:#2b6cb0,color:#e2e8f0
    style WA fill:#744210,stroke:#d69e2e,color:#e2e8f0
```

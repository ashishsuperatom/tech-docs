...
flowchart TB
    subgraph LAYERS["SECURITY LAYERS"]
        L1["Layer 1: Authentication<br>Secure login, Session tokens,<br>Role-based access control"]

        L2["Layer 2: Project Isolation<br>Separate Durable Objects,<br>Zero cross-project access"]

        L3["Layer 3: Data Protection<br>Parameterized SQL,<br>Encrypted connections, Key hashing"]

        L4["Layer 4: Message Validation<br>Zod schema validation,<br>Type-safe communication"]
    end

...
Any action can be simulated before activation. The system shows exactly what would happen: which records would be affected, what notifications would be sent, and what values would change, all without executing. Use dry-run mode during the first 1-2 weeks of a new workflow to validate its behavior.

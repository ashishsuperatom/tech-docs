...
View all generated reports and create new ones:

<Frame caption="Reports page — view and create reports">
  <img src="/images/reports-list.png" alt="Reports List" />
</Frame>

<Frame caption="Report detail view — create, schedule, and share">
  <img src="/images/report-detail.png" alt="Report Detail" />
</Frame>
...
<Frame caption="Report scheduler form">
  <img src="/images/report-scheduler.png" alt="Report Scheduler" />
</Frame>
...
<Frame caption="Manage report permissions">
  <img src="/images/report-permissions.png" alt="Report Permissions" />
</Frame>
...
```mermaid
flowchart LR
    SCHEDULE["Schedule<br>(Weekly, Monday 9 AM)"] --> GENERATE["Generate Report"]

...
flowchart TB
    subgraph PRESENTATION["PRESENTATION LAYER"]
        UI["Chat Runtime<br>(React 19)"]
        FE["Frontend Components<br>(Visualization Library)"]
        SDK_WEB["SDK-Web<br>(Browser SDK)"]
    end

    subgraph INFRASTRUCTURE["INFRASTRUCTURE LAYER"]
        DO["Durable Object WebSocket<br>(Cloudflare Edge)"]
    end

    subgraph INTELLIGENCE["INTELLIGENCE LAYER"]
        SDK_NODE["SDK-Node<br>(Core Engine)"]
        BACKEND["Backend<br>(Business Logic)"]
        ANALYSIS["Analysis<br>(Schema Tools)"]
    end

    subgraph DATA["DATA LAYER"]
        PG["PostgreSQL<br>(Relational)"]
        CHROMA["ChromaDB<br>(Vector)"]
        CUSTOMER["Customer DBs<br>(SQL Server, etc.)"]
    end
...
flowchart LR
    ...
    subgraph PROJECTS["PROJECT ISOLATION"]
        P1["Project A<br>Durable Object"]
        P2["Project B<br>Durable Object"]
        P3["Project C<br>Durable Object"]
    end

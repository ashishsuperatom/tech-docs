...
flowchart TD
    ...
    style UI fill:#e0f2fe,stroke:#0D9373
    style SDK_WEB fill:#e0f2fe,stroke:#0D9373
    style DO fill:#fef3c7,stroke:#f59e0b
    style SDK_NODE fill:#d1fae5,stroke:#0D9373
    style BACKEND fill:#d1fae5,stroke:#0D9373
    style ANALYSIS fill:#d1fae5,stroke:#0D9373
    style PG fill:#fce7f3,stroke:#ec4899
    style CHROMA fill:#fce7f3,stroke:#ec4899
    style CUSTOMER fill:#fce7f3,stroke:#ec4899
```

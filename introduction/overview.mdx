...
flowchart TB
    subgraph LOOP["THE DECISION LOOP"]
        direction TB
        A["1. UNDERSTAND<br>the data collected by the org"] --> B["2. ANALYZE<br>patterns, trends, anomalies"]
        B --> C["3. SUGGEST<br>actions that can be taken"]
        C --> D["4. VERIFY<br>human review for high-stakes"]
        D --> E["5. EXECUTE<br>commit the action"]
        E --> F["6. OBSERVE<br>track the results"]
        F --> A
    end

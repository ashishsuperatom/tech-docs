...
flowchart TB
    subgraph LOOP["THE DECISION LOOP"]
        direction TB
        A["UNDERSTAND<br>Data Collection"] --> B["ANALYZE<br>Patterns & Trends"]
        B --> C["SUGGEST<br>Actions"]
        C --> D["VERIFY<br>Human Review"]
        D --> E["EXECUTE<br>Commit"]
        E --> F["OBSERVE<br>Track Results"]
        F --> A
    end

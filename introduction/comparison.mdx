...
flowchart LR
    subgraph PEOPLE["REQUIRED PEOPLE"]
        P1["Data Engineer<br>$150K/year"]
        P2["BI Analyst<br>$120K/year"]
        P3["Dashboard Designer<br>$100K/year"]
    end

    subgraph TIME["TIME REQUIRED"]
        T1["ETL Pipeline<br>2-4 weeks"]
        T2["Query Development<br>1-2 weeks"]
        T3["Dashboard Build<br>1-2 weeks"]
    end

    subgraph RESULT["RESULT"]
        R1["Static Dashboard<br>Shows historical data"]
    end

    P1 --> T1 --> P2 --> T2 --> P3 --> T3 --> R1

    R1 --> HUMAN["Human must:<br>Interpret, Identify issues,<br>Decide, Execute manually"]
...
flowchart TB
    subgraph EVOLUTION["MARKET EVOLUTION"]
        direction LR
        E1["1990s-2000s<br>SPREADSHEETS<br>Manual analysis"]
        E2["2000s-2010s<br>BI TOOLS<br>Visualized reporting"]
        E3["2010s-2020s<br>SELF-SERVICE BI<br>User-built dashboards"]
        E4["2020s+<br>DECISION INTELLIGENCE<br>AI-powered decisions"]
    end
...
flowchart TB
    subgraph TAM["MARKET LAYERS"]
        direction TB
        L1["Traditional BI Market<br>$30B (Replacing existing spend)"]
        L2["New Decision Intelligence<br>$50B+ (New capability, new buyers)"]
        L3["Action Automation<br>$100B+ (Connected to execution)"]
    end
    ...
    SUPERATOM["Superatom<br>Addresses all three layers"]
